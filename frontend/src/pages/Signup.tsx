...
import { Train, Mail, Lock, Eye, EyeOff, AlertCircle, User } from 'lucide-react';
...
const Signup: React.FC = () => {
    ...
    try {
      ...
      if (success) {
        toast({
          ...
          description: 'Welcome to IRCTC. Start booking your train tickets.',
        });
        navigate('/login');
      } else {
      ...
      <div className="hidden lg:flex flex-1 railway-gradient relative overflow-hidden">
        ...
        <div className="relative flex flex-col items-center justify-center px-12 text-center">
          ...
          <p className="text-primary-foreground/80 max-w-sm">
            Create your account and enjoy hassle-free train bookings across India.
          </p>
          ...
          <div className="mt-12 grid grid-cols-3 gap-8">
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-primary-foreground/70">Trains</p>
            </div>
            <div className="text-center">
  ...
  <select
    ...
    className="mt-1.5 h-12 w-full rounded-md border border-input bg-background px-3"
    required
  >
    ...
    <option value="ADMIN">Admin</option>
            ...
            <Button
              type="submit"
              disabled={isLoading}
              className="w-full h-12 railway-gradient text-primary-foreground font-semibold mt-2"
            >
